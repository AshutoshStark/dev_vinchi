      ...
      <motion.div variants={slideInFromTop} className="mt-40 md:mt-6 flex gao-6 md:gap-12 flex-col md:flex-row bg-emerald-300 px-5 md:px-12 py-6 rounded-lg w-full md:max-w-3/4 bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-40">
        ...
        <div className="">
          ...
          <div className="flex flex-col gap-4 py-3">
            <motion.div variants={slideInFromLeft(0.6)} className="flex items-center gap-3">
              <img src="assets/icons/calander.svg" alt="" className="w-1/20"/>
              <p className="font-semibold text-[10px]">Flexible spaces & leases <br /> <samp className="font-medium">Leases as short as 6 months. Upscale or downscale anytime!</samp></p>
            </motion.div>
            <motion.div variants={slideInFromLeft(0.7)} className="flex items-center gap-3">
              <img src="assets/icons/wareHouse.svg" alt="" className="w-1/20"/>
              <p className="font-semibold text-[10px]">Flexible spaces & leases <br /> <samp className="font-medium">Leases as short as 6 months. Upscale or downscale anytime!</samp></p>
            </motion.div>
            <motion.div variants={slideInFromLeft(0.8)} className="flex items-center gap-3">
              <img src="assets/icons/key.svg" alt="" className="w-1/20"/>
              <p className="font-semibold text-[10px]">Flexible spaces & leases <br /> <samp className="font-medium">Leases as short as 6 months. Upscale or downscale anytime!</samp></p>
            </motion.div>
          </div>
          {/* images */}
        ...
        <motion.div variants={slideInFromRight(0.5)} className="bg-white rounded-lg p-6">
          ...
          <motion.div variants={slideInFromRight(0.7)} className="flex">
            ...
            <p className="text-[10px]">Cashana or Khadijah will answer your questions and find you a space that meets your needs. No commitment necessary!</p>
          </motion.div>
          ...
          <motion.p variants={slideInFromRight(0.7)} className="text-[10px] py-2 pb-8">Questions? Give us a call: <span className="text-[#00AA6C]">415-985-0940</span></motion.p>
          <motion.button variants={slideInFromRight(0.7)} className=' text-[9px] text-black bg-emerald-100 px-3 py-1 rounded-full shadow-m shadow-slate-400 flex items-center justify-center'>Looking for a job? <span className="underline">Click here.</span></motion.button>
        </motion.div>
      </motion.div>
    </motion.div>
  );
